...
5. WITH 절 내부의 서브쿼리들을 CTE로 재구성 (난이도: 3)

전체적인 쿼리 구조는 유지하면서 Oracle 특화 문법을 MariaDB에 맞게 조정했습니다. CHRR_META CTE의 경우 RECURSIVE를 사용하여 CONNECT BY LEVEL의 기능을 구현했습니다. 또한 DUAL 테이블 사용을 제거하고 VALUES를 사용하여 동일한 결과를 얻도록 했습니다.